...
@ContextConfiguration({
    "classpath*:spring/batch/job/readers/jdbc/jdbc-cursor-item-reader-multi-threading-job.xml",
    "classpath*:spring/batch/setup/**/*.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
public class JdbcCursorItemReaderMultiThreadingJobConfigurationTest {
    ...
    public void launchJob() throws Exception {
        ...
        jobParametersMap.put("output.file", new JobParameter("file:target/test-outputs/readers/jdbc/jdbc-cursor-item-reader-multi-threading/output.txt"));
